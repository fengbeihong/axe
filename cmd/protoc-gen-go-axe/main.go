...
// protoc-gen-go-axe is a plugin for the Google protocol buffer compiler to
...
//	protoc --go-axe_out=. path/to/file.proto
//
...
func main() {
	...
	flag.Parse()
	if *showVersion {
		fmt.Printf("protoc-gen-go-axe %v\n", version)
		return
	}
